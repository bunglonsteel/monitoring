                ...
                <div class="col-md-12 mb-md-4 mb-3">
                    <div class="card card-border mb-0 h-100">
                        <div class="card-header card-header-action">
                            <h6 id="tambah">Semua standard</h6>
                            <div class="card-action-wrap">
                                <button type="button" class="btn btn-sm btn-primary me-2" data-bs-toggle="modal" data-bs-target="#modal">
                                    <span>
                                        <span class="icon">
                                        ...
                                        <span class="btn-text">Standar</span>
                                    </span>
                                </button>
                            </div>
                        </div>
                        <div class="card-body p-3 pt-4">
                            ...
                            <table id="table-notes-standard" class="table nowrap w-100">
                                <thead>
                                    <tr>
                                        <th>No.</th>
                                        <th>Catatan Standard</th>
                                        <th class="text-center">Action</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <?php $no = 1; foreach ($notes_standard as $standard) :?>
                                        <tr class="fs-7">
                                            <td><?= $no++ ?>.</td>
                                            <td><?= $standard['notes_standard'] ?></td>
    ...
    <div class="modal-dialog modal-sm modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h6 class="modal-title">Tambah Standar</h6>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <form id="tambah-notes" class="form-floating" action="<?= base_url('notes/add_notes_standard')?>" method="POST">
                <div class="modal-body">
                    ...
                    <div class="row g-2">
                        <div class="col-12">
                            ...
                            <input type="text" class="form-control" name="notes_standard" placeholder="Ketikan standar catatan..">
                        </div>
                    </div>
                </div>
...
<script>
    $(document).ready(function () {
        ...
        $('#table-notes-standard').DataTable({
            // pageLength: 8,
            // order: [1, 'desc'],
            scrollX:  true,
            language: { search: "",
        ...
        $(document).on('click', '.btn-delete', function (e) { 
            ...
            const url = `<?= base_url('notes/delete_notes_standard/') ?>${id}`
