...
document.addEventListener("DOMContentLoaded", function () {
		...
		calendar = new FullCalendar.Calendar(calendarEl, {
			...
			events: [
				...
				},
				{
					...
					borderColor: "#298DFF",
					title:
						'<i class="ri-plane-fill"></i><span>2:35 PM  Flight to Indonesia</span>',
					url: "http://google.com/",
					start: curYear + "-" + curMonth + "-13",
					extendedProps: {
						toHtml: "convert",
	...
	$(document).on("click", ".calendarapp-wrap .fc-daygrid-event", function (e) {
		$(targetDrawer)
			.css({ border: "none", "box-shadow": "0 8px 10px rgba(0, 0, 0, 0.1)" })
